                                ...
                                <div class="pay_info">
                                    <div class="row">
                                        <div class="col-md-6 tab-grid">
                                            <img class="pp-img" style="width:400px" src="web/images/paypal.png" alt="Image Alternative text" title="Image Title">
											<h5 class="head_agileinfo text-center text-capitalize pb-5">
											<span>Amount:<label style="color:red">Rs.<?php echo $amt; ?></label> </span></h5>
                                                            ...
                                                            <div class="paymntf_card_number_grids">
                                                                ...
                                                                <div class="fpay_card_number_grid_right">
                                                                    <div class="controls">
                                                                        ...
                                                                        <input class="security-code form-control" pattern="^[0-9]{3}" required title="enter proper cvv" type="password" name="security-code">
                                                                    </div>
                                                                </div>
                                                                <div class="clear"> </div>
                                                            </div>
...
if(isset($_REQUEST['btnSubmit']))
{
  ...
  if($s)
  {
    ...
    $l="insert into tblview_payment(order_id,pay_amount,pay_type) values('$oid','$amt','Online Transaction')";
   if(mysqli_query($conn,$l))
   {
    echo "<script>location.href='usersuccess.php?id=".$oid."'</script>";
  }
  }
}
?>